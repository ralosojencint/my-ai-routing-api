...
def same_event(a, b):
    ...
    tb = event_tokens(b)
    shared = ta & tb
    if not ta or not tb or len(shared) < 2:
        return False

    # Compare headline evidence only. Article bodies often contain generic
    # boilerplate that falsely makes unrelated developments look identical.
