import os, re, json, sqlite3, asyncio, time, io, base64, hashlib, uuid, subprocess, sys, html
...
def event_tokens(source):
    # Event identity should be driven primarily by the headline. Using long
    # article bodies here falsely merges unrelated stories from the same
    # company/outlet because they share generic vocabulary.
