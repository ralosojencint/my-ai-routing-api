...
def is_relevant_ai_source(source, today):
    ...
    # Commentary/financial pieces are only allowed when the headline also
    # contains a concrete AI event verb. This keeps real announcements while
    # pushing investor commentary out of a "latest developments" list.
    ...
    if (financial_title or opinion_title) and not concrete_title_event:
        return False
