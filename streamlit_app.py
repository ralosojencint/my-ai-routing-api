...
st.markdown(
    """
    <style>
    .block-container {max-width: 820px; padding-top: 35px; padding-bottom: 30px;}
...
def ask_ai(question, sources, deep):
    ...
    mode = "DEEP RESEARCH" if deep else "QUICK RESEARCH"
    prompt = f"""
You are NEXUS, a professional research assistant.
...
Answer using the evidence when available.
Rules:
- Never invent facts.
- Cite researched claims with [1], [2], etc.
- If sources disagree, explain it.
- If evidence is insufficient, say so.
- Be clear, useful and direct.
- Have a calm personality with occasional natural humor.
- Never force jokes or sound childish.
"""
...
if send and question.strip():
    ...
    with st.spinner("Researching and thinking..." if deep else "Searching and thinking..."):
